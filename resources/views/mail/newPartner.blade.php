...
<body class="mail">
    ...
    <div class="mail-container">
        <div class="mail-context">
            <h3>Olá Parceiro!</h3>
            <p>Olá {{ $name }}, estamos super felizes em ter você como parceiro nossa plataforma!</p>

            <p>Estas são as suas informações de parceiro:</p>
            <ul class="mail-context-data">
                <li><strong>Nome do estabelecimento:</strong> {{ $partnerName }} </li>
