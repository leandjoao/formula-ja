...
<div class="main">
    ...
    <div class="main-content">
        ...
        {!! Form::model($data, ['route' => ['texts.blog.save'], 'method' => 'post', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
            @csrf
            <div class="create">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <p class="text-center photo-content">
                                        <img src="/storage/paginas/blog/{{$data->img_banner}}?rand={{rand(10,999)}}" class="img-thumbnail">
                                    </p>
                                </div>
                                @endif
