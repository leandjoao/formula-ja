...
<div class="main">
    <div class="main-header">
        <h3>Editar Página FAQ</h3>
    </div>
    
    <div class="main-content">
        {{-- <form action="{{route('texts.home.save')}}" class="form" method="POST" enctype="multipart/form-data"> --}}
        {!! Form::model($data, ['route' => ['texts.faq.save'], 'method' => 'post', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
            @csrf
            <div class="create">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <p class="text-center photo-content">
                                        <img src="/storage/paginas/faq/{{$data->img_banner}}?rand={{rand(10,999)}}" class="img-thumbnail">
                                    </p>
                                </div>
                                @endif
