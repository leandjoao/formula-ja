...
class InfoHomeController extends Controller
{
    ...
    public function home()
    {
        ...
        $data = InfoHome::findOrFail(1);
        // dd($data);
        return view('admin.paginas.info-home', compact('data'));
    }
    ...
    public function saveHome(Request $request)
    {
        ...
        $selectHome = InfoHome::findOrFail(1);
        ...
        if ($request->hasFile('img_banner')) {
            ...
            $request->file('img_banner')->storeAs("public/paginas/home/", $fileNameBanner);
        }else{
            $fileNameBanner = $selectHome->img_banner;
        }
        ...
        $infoUpdate = InfoHome::query()->first();
